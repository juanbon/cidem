...
class RecipientCrudController extends CrudController {
    public function setup() {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Recipient');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/recipients');
        $this->crud->setEntityNameStrings('destinatario', 'destinatarios');
